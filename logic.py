...
skills = [ (_,) for _ in (['Python', 'SQL', 'API', 'Telegram/Discord', 'AI', 'Pygame', 'HTML', 'CSS', 'FLASK'])]
...
class DB_Manager:
    ...
    def insert_project(self, data):
        sql = "INSERT INTO projects (project_id, project_name, description, url, status_id) values(?, ?, ?, ?, ?)"
        self.__executemany(sql, data)
...
if __name__ == '__main__':
    ...
    data = (1, 'TIC TAC TOE', 'Just a common tic tac toe game vs AI or vs Human.', 'https://github.com/GodlikeNaruto/TIC-TAC-TOE/tree/main', 2)
